...
<div className="maincontainer">
        <div id="preloder">
            ...
            <a href="#"><h4>INVENTORY MANAGEMENT</h4></a>
            </div>
            </div>
            ...
            <div className="col-12 text-end">
            <input type="text" placeholder="Type" className=""
                onChange={(e) => {
                e.preventDefault();
            ...
            <div className="row mb-2 pt-1 " >
            <div className="col-12 text-end">
            <input type="text" placeholder="Material" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="row mb-2 pt-1 ">
            <div className="col-12 text-end">
            <input type="number" placeholder="Prize" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="row mb-2 pt-1 ">
            <div className="col-12 text-end">
            <select type="text" placeholder="Offer" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="row mb-2 pt-1 ">
            <div className="col-12 text-end">
            <input type="text" placeholder="Availability" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="row mb-2 pt-1 ">
            <div className="col-12 text-end">
            <input type="text" placeholder="Delivery time" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="row mb-2 pt-1 ">
            <div className="col-12 text-end">
            <input type="text" placeholder="Upload Iamge/Video" className=""
                onChange={(e) => {
                e.preventDefault();
                // setEmail(e.target.value);
              }}
            ...
            <div className="col-2 text-end">
              <label><b><i className="fa fa-check"></i><i className="text-warning"> Agree </i></b></label>
            </div>
            </div>
